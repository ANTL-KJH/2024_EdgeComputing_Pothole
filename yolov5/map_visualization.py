...
class pothole_visualization:
    def __init__(self):
        # 지도 생성 (위치: 서울, 줌 레벨: 12)
        self.map = folium.Map(location=[35.830615, 128.754465], zoom_start=12)  # 영남대학교 IT 관 기준
        # UDP 서버 설정
    ...
    def receive_data(self):
        while True:
            ...
            # 수신된 메시지 형식: "latitude,longitude,popup,image_path"
            latitude, longitude, popup, recv_img = message.split(',')
